...
public class CustManagement {
    ...
    public int[] custScore;
	   ...
	   */
        ...
        */
	    public void add(){
	    	System.out.println("斑马购物管理系统 > 客户信息管理 > 添加客户信息\n\n");
	    	Scanner input = new Scanner(System.in); 
	    	int no  = -1;	    	
	    	while(true) {
	    		try {
	    ...
	    /**
	      ...
	      */
		public void modify(){
			 System.out.println("斑马购物管理系统 > 客户信息管理 > 修改客户信息\n\n");
		 ...
		 /**
	       ...
	       */  
		  public void search(){
			 System.out.println("斑马购物管理系统 > 客户信息管理 > 查询客户信息\n");
			 String con = "y";
			 Scanner input = new Scanner(System.in);
			 while(con.equals("y")){
			   System.out.print("请输入会员号：");
		    ...
		    /**
		      ...
		      */
			public void show(){
				System.out.println("斑马购物管理系统 > 客户信息管理 > 显示客户信息\n\n");
				System.out.println("  会员号            生日             积分      ");	     
				System.out.println("------------|------------|---------------");
